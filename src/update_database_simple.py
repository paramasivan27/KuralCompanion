"""
Simplified script to update the Kural database files using thirukkural.json
Uses JSON serialization to avoid string formatting issues
"""
...
def create_database_file_simple(kurals, filename, description):
    """Create a database file using JSON serialization"""
...
# {description}
KURAL_DATABASE_JSON = """{json.dumps(theme_organized, ensure_ascii=False, indent=2)}"""

# Load the database
KURAL_DATABASE = json.loads(KURAL_DATABASE_JSON)
...
def main():
    ...
    create_database_file_simple(core_kurals, 'kural_database.py', 'Thirukkural Database - Core collection of 400 kurals')
    create_database_file_simple(comprehensive_kurals, 'comprehensive_kurals.py', 'Comprehensive Thirukkural Database - Extended collection of 400 kurals')
    create_database_file_simple(extended_kurals, 'extended_kurals.py', 'Extended Thirukkural Database - Complete collection of remaining kurals')
